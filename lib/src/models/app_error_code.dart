...
extension AppErrorCodeLabel on AppErrorCode {
  ...
  String get message {
    switch (this) {
      ...
      case AppErrorCode.remoteNotFound:
        return 'Remote resource was not found.';
      case AppErrorCode.conflictDetected:
        return 'A sync conflict was detected.';
      case AppErrorCode.validationFailed:
        return 'Validation failed.';
      case AppErrorCode.unsupportedSchema:
        return 'Schema version is unsupported.';
      case AppErrorCode.operationNotImplemented:
